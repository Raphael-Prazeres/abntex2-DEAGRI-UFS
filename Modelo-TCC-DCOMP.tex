...
\titulo{Modelo Canônico de Trabalho Acadêmico com abnTeX2: Customização para o Departamento de Engenharia Agrícola} 
\autor{Digite seu nome completo}
\orientador{Digite o nome do seu orientador}
\coorientador{Digite o nome do seu coorientador}
